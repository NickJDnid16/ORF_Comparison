...
MetaGeneMarkOutput = open('./MetaGeneMark_Metrics.csv', mode='wb')
...
for line in MetaGeneMarkInput:
    if "Chromosome" in line:
        ...
        MetaGeneMarkORFs.update({Start:Stop})

Output, Start_Precision, Stop_Precision = orfComparison(Genes, MetaGeneMarkORFs, Start_Codons,Stop_Codons, Genome)

MetaGeneMarkOutput.write(str(Output)+'\n')
MetaGeneMarkOutput.write(str(Start_Precision)+'\n')
MetaGeneMarkOutput.write(str(Stop_Precision)+'\n')
