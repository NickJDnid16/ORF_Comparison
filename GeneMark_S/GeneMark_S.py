...
GeneMark_S_Output = open('./GeneMark_S_Metrics.csv', mode='wb')
...
GeneMark_S_ORFsFiltered = collections.OrderedDict()
...
for line in GeneMark_S_Input:
    if "Chromosome" in line:
        ...
        GeneMark_S_ORFs.update({Start:Stop})

Output, Start_Precision, Stop_Precision = orfComparison(Genes, GeneMark_S_ORFs, Start_Codons,Stop_Codons, Genome)
GeneMark_S_Output.write(str(Output) + '\n')
GeneMark_S_Output.write(str(Start_Precision) + '\n')
GeneMark_S_Output.write(str(Stop_Precision) + '\n')
